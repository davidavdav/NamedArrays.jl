...
## different names
m2 = NamedArray(rand(10), (letters[11:20],))
mm = hcat(m, m2)
@test mm.array == hcat(m.array, m2.array)
...
## matrix
## same names
m = NamedArray(rand(10, 10), (letters[1:10], letters[11:20]))
m2 = NamedArray(rand(10, 10), (letters[1:10], letters[11:20]))
mm = hcat(m, m2)
@test mm.array == hcat(m.array, m2.array)
@test namesanddim(mm,1) == namesanddim(m,1)
...
## different names
m2 = NamedArray(rand(10, 10), (letters[11:20], letters[1:10]))
mm = hcat(m, m2)
@test mm.array == hcat(m.array, m2.array)
@test names(mm, 1) != names(m2, 1)
